      ...
      <div ref={chatContainerRef} className="flex-1 overflow-y-auto pb-32 pt-4">        
        <div className="max-w-3xl mx-auto px-4 pr-0">          
          {messages.map((msg, index) => (            
            ...
            >              
              {msg.role === "ai" && <AiBotIcon />} {/* Use AiBotIcon component here */}              
              <div className={`px-4 py-2 rounded-2xl max-w-[80%] ${msg.role === "ai" ? "text-gray-100" : "bg-[#1F2937] text-white ml-auto"}`}>                
      ...
      <div className="fixed bottom-0 w-full" style={{ backgroundColor: "#111827" }}>        
        <div className="max-w-3xl mx-auto pb-4">          
          <div className="flex gap-3 items-center relative">            
            ...
            /> {/* Use ChatButton component here */}          
          </div>        
        </div>      
      </div>      

      <ScrollDownButton onClick={scrollToBottom} /> {/* Use ScrollDownButton component here */}
    </div>  
  );  
}
